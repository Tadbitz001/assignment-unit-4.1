...
console.log(addNumbers(4,36));

// 4. Function to multiply three numbers & return the result
function multiplyThree(fistNum, secNum, thirdNum ){
let total = fistNum * secNum * thirdNum;
return total;
}
console.log(multiplyThree(3,5,2));
...
function posSumArray(inputArray) {
  let positiveNum = [];
